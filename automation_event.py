...
def run_farming_cycle():
    ...
    # ==========================================
    #   PERCABANGAN RUTE BARU SETELAH STEP 20
    # ==========================================
    print("\n[Info] Step 20 selesai. Memeriksa keberadaan tombol 'Try Again' (maksimal 3x percobaan)...")
    time.sleep(2.0)
    ...
    # 2. Jika 'Try Again' tidak ketemu sama sekali setelah 3x percobaan, masuk rute alternatif
